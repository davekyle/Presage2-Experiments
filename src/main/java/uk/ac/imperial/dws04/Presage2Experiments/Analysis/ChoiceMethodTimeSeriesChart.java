...
public class ChoiceMethodTimeSeriesChart implements TimeSeriesChart, Serializable {
	...
	/**
	 * I would love to be able to get this properly, but...
	 */
	private static final int endTime = 100;
	...
	public ChoiceMethodTimeSeriesChart(OwnChoiceMethod choiceMethod, XYDataset data, String chartType) {
	...
	private static final String generateYLabel(final String chartType) {
		...
		else if (chartType.equalsIgnoreCase(GraphBuilder.dissTitle)) {
