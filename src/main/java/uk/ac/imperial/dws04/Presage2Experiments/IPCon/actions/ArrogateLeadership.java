...
public class ArrogateLeadership extends IPConAction {
	 ...
	 * @param cluster
	 */
	public ArrogateLeadership(IPConAgent agent, Integer revision,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ArrogateLeadership other = (ArrogateLeadership) obj;
		if (agent == null) {
			if (other.agent != null)
				return false;
	...
	public String toString() {
		return "ArrogateLeadership [agent=" + agent + ", revision=" + revision
